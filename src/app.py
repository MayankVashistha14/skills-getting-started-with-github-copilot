...
activities = {
    ...
    "Science Olympiad": {
        "description": "Prepare for STEM competitions and solve challenging problems",
...
def unregister_participant(activity_name: str, email: str):
    ...
    if email not in activity["participants"]:
        raise HTTPException(status_code=404, detail=f"Student {email} is not found in {activity_name}")
